  ...
  return (
    <main className="auth-page">
      <div className="auth-box panel">
        ...
        <p>Use `owner@maintiva.local` and `password123` after seeding the demo database.</p>
        {searchParams.error ? <p className="badge danger" style={{ whiteSpace: "normal" }}>{searchParams.error}</p> : null}
        <form className="form" action={loginAction}>
          <label>Email<input name="email" type="email" defaultValue="owner@maintiva.local" required /></label>
