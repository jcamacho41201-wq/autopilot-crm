      ...
      <section className="split">
        <div className="panel">
          ...
          <div className="table-wrap">
            <table>
              <thead><tr><th>Vehicle</th><th>Service</th><th>Remaining</th><th>Due</th><th>Learned miles/year</th><th>Complete</th></tr></thead>
              <tbody>
                {ranked.map(({ item, prediction }) => (
                  <tr key={item.id}>
                    <td>{item.vehicle.customer.name}<br /><span className="muted">{item.vehicle.year} {item.vehicle.make} {item.vehicle.model}</span></td>
                    ...
                    <td>{prediction.annualMiles.toLocaleString()}</td>
                    <td>
                      <form className="form" action={completeServiceAction}>
